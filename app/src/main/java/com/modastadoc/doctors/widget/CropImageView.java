...
public class CropImageView extends ImageView
{
    ...
    public String getCroppedBitmapSize()
    {
        Bitmap source = getBitmap();
        if (source == null) return null;
    ...
    public RectF getActualCropRect()
    {
        ...
        Log.e("CIV_ACTUAL", "" + offsetX + " " + offsetY);
        Log.e("CIV_ACTUAL+MFRA", "" + mFrameRect.left + " " + mFrameRect.top + " " + mFrameRect.right + " " + mFrameRect.bottom);
