...
public class ArcProgress extends View {
    ...
    String TAG = ArcProgress.class.getSimpleName();
    private Paint paint;
    ...
    private final int default_finished_color   = Color.rgb(  75, 164, 203 );
//    private final int default_unfinished_color = Color.rgb( 255, 255, 255 ) ;
    private final int default_unfinished_color = Color.argb( 190 , 0 , 0 , 0 );
