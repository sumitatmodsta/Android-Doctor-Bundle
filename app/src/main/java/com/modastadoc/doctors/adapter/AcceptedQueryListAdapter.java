 ...
 */
public class AcceptedQueryListAdapter extends RecyclerView.Adapter<AcceptedQueryListAdapter.ViewHolder>
{
    ...
    public AcceptedQueryListAdapter(ArrayList<String> q_Idlist, ArrayList<String> mDataset, ArrayList<String> quesrDateList, ArrayList<String> q_Statuslist, Context context)
    {
    ...
    public void onBindViewHolder(ViewHolder holder, int position)
    {
        ...
        final String qStatus = q_Statuslist.get(position);
        ...
        {
            holder.tv_status.setText("[Answer now]");
