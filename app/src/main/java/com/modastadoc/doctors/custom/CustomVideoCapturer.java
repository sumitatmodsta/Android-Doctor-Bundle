package com.modastadoc.doctors.custom;
...
public class CustomVideoCapturer extends BaseVideoCapturer implements
        PreviewCallback, BaseVideoCapturer.CaptureSwitch {

    private final static String LOGTAG = "CustomVideoCapturer";
    ...
    private final static int PREFERRED_CAPTURE_WIDTH = 480;
