 ...
 */
public class AnsweredQueryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answeredquery);
    ...
    private void getAcceptedQuery() {
        ...
        PostApi postApi = new PostApi(new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.v("AcceptedQuery", "Response : " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.v("Error in AcceptedQuery", "Error Response : " + error.toString());
                dismissDialog();
    ...
    private void showDialog(String message) {
        ...
        alertDialog = new ProgressDialog(AnsweredQueryActivity.this);
